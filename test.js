...
// const categories = product.map((p) => {
//     if(!p.category){
//         return null
//     }
//     return p.category.split('-').join(' ')
// })
// const brands = product.map((p) => {
//     if(!p.brand){
//         return null
//     }
//     return p.brand
...
// const p = [...new Set(brands)]


// const all=p.slice(0,p.length-1)
// const allcat=c.slice(0,c.length-1)

// const cate= allcat.map((cat) => (
//     {
...
//     })
// )
// const br= all.map((bra) => (
//     {
//         value: bra.toLowerCase(),
//         label: bra.toUpperCase(),
//         checked: false
//     })
// )
...
const calculation = data.reduce((amount, item) => item.quantity + amount, 0)
