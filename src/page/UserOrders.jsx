...
import {
  getLoggedInUserOrdersByIdAsync,
  // selectLoggedInUserInfoById,
...
const UserOrders = () => {
  ...
  const ordersStatus = useSelector((state) => state.user.status);
  console.log(ordersStatus);
  useEffect(() => {
    dispatch(getLoggedInUserOrdersByIdAsync());
  }, [dispatch, user]);
      ...
      {orders?.map((order) => (
        ...
        >
          ...
          <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            <div className="flex justify-between gap-x-6 px-5 py-5 border-solid border mt-2 border-gray-200">
