...
import { getAllOrderAsync, selectOrderItem, selectTotalOrder, updateOrderAsync } from '../../features/Order/orderSlice';
...
function AdminOrders() {
  ...
  useEffect(() => {
    ...
    dispatch(getAllOrderAsync({ sort, pagination }));
  }, [dispatch, page, sort]);
          ...
          <div className="bg-white rounded my-6">
            <table className="min-w-max w-full table-auto">
              ...
              <tbody className="text-gray-600 text-sm font-light">
                {orders.map((order) => (
                  <tr key={order} className="border-b border-gray-200 hover:bg-gray-100">
