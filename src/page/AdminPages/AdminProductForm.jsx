    ...
    >
      <div className="space-y-12 bg-white p-12">
        <div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-2xl font-bold leading-7 text-green-900">
            Add/Edit Product
          </h2>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  {brands.map((brand) => (
                    <option key={brand} value={brand.value}>{brand.label}</option>
                  ))}
                </select>
              </div>
            </div>
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                <select
                 className='border-2 border-solid p-2 rounded-md'
                  {...register('category', {
